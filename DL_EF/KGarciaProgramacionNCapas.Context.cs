...
namespace DL_EF
{
    ...
    public partial class KGarciaProgramacionNCapasEntities1 : DbContext
    {
        public KGarciaProgramacionNCapasEntities1()
            : base("name=KGarciaProgramacionNCapasEntities1")
        {
        }
        ...
        public virtual int UsuarioAdd(string nombre, string apellidoPaterno, string apellidoMaterno, string email, Nullable<int> idRol, string password, string sexo, string telefono, string celular, string fechaNacimiento, string curp, byte[] imagen, string userName, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
            var nombreParameter = nombre != null ?
                new ObjectParameter("Nombre", nombre) :
                new ObjectParameter("Nombre", typeof(string));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioAdd", nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, emailParameter, idRolParameter, passwordParameter, sexoParameter, telefonoParameter, celularParameter, fechaNacimientoParameter, curpParameter, imagenParameter, userNameParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, idColoniaParameter);
        }
        ...
        public virtual int UsuarioUpdate(Nullable<int> idUsuario, string nombre, string apellidoPaterno, string apellidoMaterno, string email, Nullable<int> idRol, string password, string sexo, string telefono, string celular, string fechaNacimiento, string curp, byte[] imagen, string userName, Nullable<int> idDireccion, string calle, string numeroInterior, string numeroExterior, Nullable<int> idColonia)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("UsuarioUpdate", idUsuarioParameter, nombreParameter, apellidoPaternoParameter, apellidoMaternoParameter, emailParameter, idRolParameter, passwordParameter, sexoParameter, telefonoParameter, celularParameter, fechaNacimientoParameter, curpParameter, imagenParameter, userNameParameter, idDireccionParameter, calleParameter, numeroInteriorParameter, numeroExteriorParameter, idColoniaParameter);
        }
